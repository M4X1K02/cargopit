...
use simapi_sys::{
    ...
    OFF_IDLERPM, OFF_MAXRPM, OFF_MTICK, OFF_PLAYER_FLAG, OFF_PROXIMITY, OFF_PROX_RADIUS,
    OFF_PROX_THETA, OFF_PULSES, OFF_RPMS, OFF_SIMAPI, OFF_SUSP_VELOCITY, OFF_TURBOBOOST,
