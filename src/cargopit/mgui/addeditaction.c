...
static Layout *i_modal_layout(AddDeviceData *data, App* app, CargopitSettings* ms, enum device_action dev_action, int confignum, int devicenum);
...
static void i_OnTestDevice(AddDeviceData *data, Event *e)
{
    ...
    window_title(data->apppointer->window3, "cargopit");
...
Panel *adddevice_window(Window *parent, App* app, CargopitSettings* ms, enum device_action dev_action, int confignum, int devicenum)
{
    Panel *panel = panel_create();
