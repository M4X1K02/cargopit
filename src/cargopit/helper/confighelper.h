...
typedef enum
{
    CARGOPIT_GEAR_REVERSE = 0,
    CARGOPIT_GEAR_NEUTRAL = 1,
    CARGOPIT_GEAR_ONE     = 2,
    CARGOPIT_GEAR_TWO     = 3,
    CARGOPIT_GEAR_THREE   = 4,
    CARGOPIT_GEAR_FOUR    = 5,
    CARGOPIT_GEAR_FIVE    = 6,
    CARGOPIT_GEAR_SIX     = 7,
    CARGOPIT_GEAR_SEVEN   = 8,
    CARGOPIT_GEAR_EIGHT   = 9,
}
CargopitGear;

typedef enum
{
    CARGOPIT_ERROR_NONE                     = 0,
    CARGOPIT_ERROR_UNKNOWN                  = 1,
    CARGOPIT_ERROR_INVALID_SIM              = 2,
    CARGOPIT_ERROR_INVALID_DEV              = 3,
    CARGOPIT_ERROR_NODATA                   = 4,
    CARGOPIT_ERROR_UNKNOWN_DEV              = 5,
    CARGOPIT_ERROR_UNSUPPORTED_SIM_FEATURE  = 6,
    CARGOPIT_ERROR_SIMD_REQUIRED            = 7,
}
CargopitError;
