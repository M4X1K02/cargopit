...
int cargopit_initialize(int argc, char** argv)
{
...
static void i_OnAddEdit(App* app, Event *e, enum device_action device_action)
{
    ...
    window_title(app->window2, "cargopit");
...
static Panel *i_panel(App *app, CargopitSettings* ms)
{
...
static App *i_create(void)
{
    ...
    // do some cargopit things here
    ms.tyre_diameter_config = NULL;
    ms.config_str = NULL;
    ms.log_filename_str = NULL;
    ms.log_dirname_str = NULL;

    cargopit_initialize(m_argc, m_argv);
    ms.cfg = open_cargopit_config(ms.config_str);
    ...
    dbind_enum(CargopitTyreIdentifier, FRONTLEFT, "Front Left");
    dbind_enum(CargopitTyreIdentifier, FRONTRIGHT, "Front Right");
    dbind_enum(CargopitTyreIdentifier, REARLEFT, "Rear Left");
    dbind_enum(CargopitTyreIdentifier, REARRIGHT, "Rear Right");
    dbind_enum(CargopitTyreIdentifier, FRONTS, "Fronts");
    dbind_enum(CargopitTyreIdentifier, REARS, "Rears");
    dbind_enum(CargopitTyreIdentifier, ALLFOUR, "All Four");
    ...
    window_title(app->window, "cargopit");
