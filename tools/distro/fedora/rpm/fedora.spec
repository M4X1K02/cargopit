#dnf install pulseaudio-libs-devel argtable-devel libconfig-devel hidapi-devel libserialport-devel lua-devel libuv-devel libxdg-basedir-devel libxml2-devel procps-ng-devel rust cargo
...
cp $RPM_BUILD_DIR/monocoque/build/tui/release/cargopit-tui $RPM_BUILD_ROOT/usr/bin/cargopit-tui
