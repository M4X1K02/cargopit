...
pub const LOADING_IDLE: &str = "idle";
pub const LOADING_LABEL: &str = "loading";
pub const LOADING_LOADED: &str = "loaded";
pub const LOADING_ERROR_PREFIX: &str = "discovery error";
pub const REFRESH_CHANNEL_CLOSED: &str = "refresh channel closed";
pub const ENABLED_MARK: &str = "*";
pub const DISABLED_MARK: &str = "-";
pub const IDENTITY_EMPTY: &str = "(none)";
pub const DEVICE_COL_ENABLED: &str = "On";
pub const DEVICE_COL_SUMMARY: &str = "Device";
pub const DEVICE_COL_IDENTITY: &str = "Identity";
pub const DEVICE_COL_PRESENCE: &str = "Present";
pub const TYRE_COL_SIM: &str = "Sim";
pub const TYRE_COL_CAR: &str = "Car";
pub const TYRE_COL_T0: &str = "T0";
pub const TYRE_COL_T1: &str = "T1";
pub const TYRE_COL_T2: &str = "T2";
pub const TYRE_COL_T3: &str = "T3";
pub const ERR_NOT_TTY: &str = "cargopit-tui needs a real terminal (stdout is not a TTY)";
pub const DOCS_SIMAPI_URL: &str = "https://spacefreak18.github.io/simapi/";
pub const FORM_INPUT_TITLE: &str = "Edit (Enter commit, Esc cancel)";
pub const DEVICE_DETAIL_TITLE: &str = "Selected";
pub const GAUGE_VOLUME_TITLE: &str = "Volume";
pub const GAUGE_AMPLITUDE_TITLE: &str = "Amplitude";
pub const GAUGE_FANPOWER_TITLE: &str = "Fan power";
...
pub const LAYOUT_DEVICE_DETAIL_HEIGHT: u16 = 8;
pub const LAYOUT_FORM_INPUT_HEIGHT: u16 = 3;
pub const LAYOUT_TUNE_GAUGE_HEIGHT: u16 = 3;
pub const LAYOUT_SCROLLBAR_MARGIN: u16 = 1;
pub const LIST_HIGHLIGHT_SYMBOL: &str = "> ";
pub const DEVICE_COL_ENABLED_WIDTH: u16 = 4;
pub const DEVICE_COL_PRESENCE_WIDTH: u16 = 12;
pub const DEVICE_COL_SUMMARY_MIN: u16 = 20;
pub const DEVICE_COL_IDENTITY_MIN: u16 = 12;
pub const TYRE_COL_NAME_MIN: u16 = 8;
pub const TYRE_COL_VALUE_WIDTH: u16 = 8;
pub const CONFIRM_POPUP_WIDTH: u16 = 50;
pub const CONFIRM_POPUP_HEIGHT: u16 = 5;
pub const GAUGE_RATIO_MIN: f64 = 0.0;
pub const GAUGE_RATIO_MAX: f64 = 1.0;
pub const FANPOWER_GAUGE_MAX: f64 = 1.0;
pub const INPUT_CURSOR_PADDING: u16 = 1;
